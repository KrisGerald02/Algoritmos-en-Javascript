...
/*
Ejercicio 5
Crear una función que calcule el valor de tu hora de trabajo, introduciendo tu sueldo mensual como parámetro. PD: considerá que tu mes de trabajo tiene 40 horas.
*/
const promt = require("prompt sync")({ sight: true});
...
// y calcule el IMC de una persona. Luego, ejecutar la función
// probando diferentes valores.

function calculatorIMC(metros, peso) {
  let cuenta = peso / (metros * metros);
  return cuenta;
}

console.log("Su IMC es: " + calculatorIMC(1.57, 70));
